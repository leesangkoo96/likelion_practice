var num = 1;
        ...
        var result={
            ...
            "ISTP":{
                ...
                "champ": "카르마", 
                "nickname": "깨우친 자", 
                "explain": '"아이오니아의 영적인 전통을 카르마보다 잘 나타내는 필멸자가 있을까.<br> 지난 시간 동안 축적된 기억을 새로운 생명으로 온존하며 수없이 부활한<br>고대 영혼의 살아있는 현신으로, 극소수만이 깨우칠 수 있는 힘을 손에 넣었다.<br> 최근 위기가 닥쳤을 때 최선을 다해 자신을 따르는 이들을 이끈 카르마는<br> 자신과 자신이 그토록 아끼는 조국 모두가 상당한 대가를 치러야만<br> 평화와 조화가 찾아오리라는 것을 알고 있다."', 
            ...
            "ESTP":{
                ...
                "champ": "그라가스", 
                "nickname": "술취한 난동꾼", 
                "explain": '"그라가스는 한 번 보면 잊기 힘든 쾌활한 주조가로, 어디서 왔는지는 아무도 모르지만,<br> 프렐요드의 불모지를 뒤지며 희귀한 재료를 찾아 주조법을 하나씩 시험해 보고 있다.<br>대부분 술에 취해 있어 소동을 일으키는 데에는 전설적인 소질이 있는데,<br> 그 소동은 밤샘 파티와 엄청난 기물 파손으로 이어지기 일쑤다.<br> 그라가스를 보게 된다면 곧 음주, 그리고 파괴가 잇따를 것이라고 생각해도 좋다!"', 
            ...
            "ISFJ":{
                ...
                "champ": "갈리오", 
                "nickname": "위대한 석상", 
                "explain": '"아스라한 빛의 도시 데마시아의 성문 밖<br>거대한 석상 갈리오가 경계의 눈을 늦추지 않고 서 있다. . .<br>마법사의 공격으로부터 데마시아를 수호하기 위해 만들어진 갈리오는<br>강력한 마법의 힘이 그를 깨울 때까지<br> 수십 년, 때로는 수백 년 동안 한자리에 미동도 없이 서있다.<br> 일단 깨어나면 전투의 아찔한 스릴과 데마시아인들을 구한다는 자부심을 음미하며<br>1분 1초도 허투루 쓰는 법이 없다.<br>그러나 그가 쟁취한 승리의 향기는 결코 달콤하지만은 않다.<br>아이러니하게도 그가 물리친 마법의 힘이 그에게 생명을 준 원천이기에<br> 전쟁을 승리로 장식한 후에는 다시 깊은 잠으로 빠져든다. . ."', 
                "lines": '"힘을 발휘할 시간이군. . ."',
            ...
            "ISFP":{
                ...
                "cha mp": "소나", 
                "nickname": "현의 명인", 
                "explain": '"소나는 말을 하지 못하며<br>오로지 우아한 화음과 심금을 울리는 아리아로만 의사를 표현한다.<br>특유의 고상한 몸가짐 때문에 데마시아 상류층의 사랑을 받지만,<br>듣는 이의 마음을 사로잡는 소나의 선율이 실제로 마법이 아닌가 의심하는 사람들도 많다.<br>알다시피 마법은 데마시아에서 금기시되고 있기 때문이다.<br> 소나는 낯선 이들에게 침묵을 지키지만,<br>가까운 지인들은 그녀의 의사를 어느 정도 이해한다.<br>소나가 연주하는 화음은 아군의 상처를 어루만질 뿐 아니라<br>방심하고 있는 적을 공격하기도 한다. . .', 
            ...
            "ESFP":{
                ...
                "champ": "직스", 
                "nickname": "마법공학 폭파병",
                "explain": '"거대한 폭탄을 사랑하는 직스는 폭탄만큼이나 화끈한 성미를 지닌 요들이다.<br> 필트오버에서 어느 발명가를 돕는 조수로 일하다가,<br>반복되는 일상에 싫증을 느끼던 중 파란 머리의 미친 폭탄광 징크스와 친구가 되었다.<br>필트오버에서 요란스러운 밤을 보낸 후 직스는 징크스의 조언을 듣고 자운으로 향했다.<br>처음 가본 자운은 직스에게 최고의 놀이터이자 천국이었다!<br>제일 좋아하는 폭탄을 마음껏 터뜨리고 무엇이든 내키는 대로 폭발시키며,<br>자운 시민뿐 아니라 화공 남작들까지 공포에 질리게 만들고 있으니. . !"', 
                "lines": '"뻥~이요!"',
            ...
            "ESFJ":{
                ...
                "champ": "럭스", 
                "nickname": "광명의 소녀", 
                "explain": '"럭스는 마법 능력을 가진 자를 공포와 의심을 담은 시선으로 보는 환경에서 태어났다.<br>고귀한 가문의 딸이지만 빛을 자유자재로 다루는 마법력을 타고났기에<br>이 능력이 발각되면 추방당할 것이라는 두려움을 안고 어린 시절을 보냈다.<br>자신의 능력을 감추는 것만이 가문의 명예를 지키는 방법이라고 여겼지만,<br>낙천적이고 유연한 성격 덕분에 차츰 자신만의 재능을 인정하고 받아들였고,<br>이제는 조국을 위해 마법을 은밀하게 사용하고 있다. . . !"', 
            ...
            "ENFP":{
                ...
                "champ": "이즈리얼", 
                "nickname": "무모한 탐험가", 
                "explain": '"마법에 타고난 재능을 가진 멋진 모험가 이즈리얼은 오래전에 사라진<br>지하 묘지를 탐험하고 고대 저주에 맞서 싸우며 힘든 역경을 손쉽게 극복한다.<br>끝없는 용기와 무모함을 지닌 그는 위기상황에서 즉흥적으로 헤쳐나가는 것을 즐긴다.<br>기지를 발휘할 때도 있지만,<br>대부분은 파괴적이고 불가사의한 폭발을 일으키는 슈리마의 신비한 장갑에 의지한다.<br>한 가지 분명한 사실은 이즈리얼이 가는 곳에 말썽이 있다는 것이다.<br> 혹은 바로 눈앞에 있거나, 사방에 있을지도 모른다. . . !"', 
            ...
            "ENFJ":{
                ...
                "champ": "뽀삐", 
                "nickname": "망치의 수호자", 
                "explain": '"룬테라에는 용맹한 챔피언이 넘쳐나지만<br>뽀삐만큼 끈기 넘치는 이는 찾아보기 힘들다.<br>제 키의 두 배는 되는 망치 오를론을 들고 다니는 뽀삐는<br>오랫동안 망치의 정당한 주인이자 전설의 주인공인<br>데마시아의 영웅을 찾아 비밀스럽게 헤매고 있다.<br>그 때까지 뽀삐는 충실히 전투로 돌격해 망치를 크게 휘둘러<br>왕국의 적을 모두 날려 버린다. . !"', 
                "lines": '"영웅이라뇨!<br>전 그저 망치를 든 요들일 뿐이에요"',
            ...
            "INTJ":{
                ...
                "champ": "제이스", 
                "nickname": "미래의 수호자", 
                "explain": '"영민한 발명가 제이스는 필트오버의 수호와 진보를 위해서라면<br>무엇이든 할 수 있는 필트오버의 영웅이다.<br>마법공학 변신 해머를 전용무기로 사용하는 그는<br>자신의 힘과 용기, 지능을 언제든 조국을 위해 바칠 각오가 되어있다.<br>필트오버의 전 국민이 제이스를 영웅으로 추대하지만<br>정작 그는 이러한 관심을 반기지 않는다.<br>그에 대한 국민들의 칭송과 감탄이<br> 적을 도발할 수 있다는 것을 누구보다 잘 알고 있기 때문이다.<br>조국에 대한 제이스의 충성심을 모르는 사람은 아무도 없으며<br>그의 능력을 시기하는 이들조차<br>진보의 도시를 수호하는 제이스의 노고에 감사를 표한다."', 
            ...
            "INTP":{
                ...
                "champ": "질리언", 
                "nickname": "시간의 수호자", 
                "explain": '"한때 이케시아의 강력한 마법사였던 질리언은<br> 자신의 고국이 공허에 파괴되는 것을 목격한 후 시간의 흐름에 사로잡히게 되었다.<br>질리언은 처참한 상실감에 슬퍼할 틈도 없이<br>미래의 모든 경우의 수를 예측하기 위해 시간 마법의 주문을 외웠다.<br>이제 사실상 불멸의 몸이 된 질리언은 정처없이<br>과거, 현재, 미래 시간대를 표류하며 이케시아를 멸망하기 전으로 돌려 놓을 시점을 찾아<br>모든 시간대에서 망연히 부유하고 있다. . !"', 
                "lines": '"그리할 줄 알고 있었소. . ."',
            ...
            "ENTP":{
                ...
                "champ": "빅토르", 
                "nickname": "기계화의 전령관", 
                "explain": '"새로운 기술 시대의 도래를 알리는 전령 빅토르는 인류의 진보에 평생을 바쳤다.<br>인류의 지식수준을 한 단계 높이고자 하는 이상을 마음속에 간직한 채<br>기술의 영광된 진화만이 인간의 잠재력을<br>완전히 발현시킬 수 있는 유일한 방법이라고 믿는다.<br>강철과 과학의 힘을 빌려 기계 인간으로 거듭난 빅토르는<br>인류의 밝은 미래를 위해 온 힘을 다한다. . !"', 
            ...
            "ENTJ":{
                ...
                "champ": "자르반4세", 
                "nickname": "데마시아의 귀감", 
                "explain": '"라이트실드 왕조의 자손인 자르반 왕자는 데마시아의 왕좌를 물려받을 후계자이다.<br>데마시아의 덕목을 대표하는 귀감으로 자라난 자르반 왕자는 자신의 어깨에<br>짊어진 큰 기대와 전선에서 싸우고 싶다는 개인적 욕망 사이에서 갈등해야 했다.<br>자르반 왕자는 가공할 만한 용기와 자신을 돌보지 않는 투지로 병사들을 고무시키며,<br>데마시아의 깃발을 높이 들고 미래의 지도자로서 진정한 힘을 뿜어낸다."', 
