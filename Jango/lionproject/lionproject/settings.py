...
"""
import os
import mblog_settings

DATABASES = mblog_settings.DATABASES
SECRET_KEY = mblog_settings.SECRET_KEY
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'blog', 'static')] #현재 static 파일들이 어디에 있는지

STATIC_ROOT = os.path.join(BASE_DIR, 'static')

MEDIA_ROOT = os.path.join(BASE_DIR, 'media') #이용자가 업로드한 파일들이 모이는곳
MEDIA_URL = '/media/' 
